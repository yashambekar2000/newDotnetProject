...
namespace NewDotnetProject.Controllers
{
  ...
  [ApiController]
    public class TestAppController : ControllerBase{
        ...
        public TestAppController(IMapper mapper, ILogger<TestAppController> iLogger,IStudentsRepository studentRepo){
            _iLogger = iLogger;
...
//=============== HTTP Get Request for getting Data ==========================
    ...
    {
      _iLogger.LogInformation("getStudents method started....");
      ...
      _iLogger.LogInformation("getStudents method ended....");
    ...
    public async Task<ActionResult<string>> deleteStudentById(int id)
    {
      ...
      if (getStudent == null)
      {
        _iLogger.LogWarning("Student with id not found.");
    ...
    public async Task<ActionResult<ModelAlias.StudentDTO>> updateStudent([FromBody] ModelAlias.StudentDTO model)
    {
      ...
      {
        _iLogger.LogWarning("bad request in updateStudent method.");
        return BadRequest();
      }
      ...
      if (getStudent == null)
      {
        _iLogger.LogError("student with id not found in updateStudent method.");
       return NotFound();
      }
      #region  Copy studentDTO to studentData object ==============
    ...
    public ActionResult testLogging()
    {
      ...
      _iLogger.LogTrace("log from trace method");
      _iLogger.LogDebug("log from debug method");
      _iLogger.LogInformation("log from information method");
      _iLogger.LogWarning("log from warning method");
      _iLogger.LogError("log from error method");
      _iLogger.LogCritical("log from critical method");
